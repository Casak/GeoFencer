...
public class PointConverterTest {
    ...
    public void convertToStorage_fromEmptyPoint_returnEmptyStoragePoint() {
        casak.ru.geofencer.domain.model.Point point = new casak.ru.geofencer.domain.model.Point();
    ...
    public void convertToDomain_fromEmptyPoint_returnEmptyDomainPoint(){
        ...
        casak.ru.geofencer.domain.model.Point result = PointConverter.convertToDomain(point);
